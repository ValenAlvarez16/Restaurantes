<style>
  body {
    background-image: url("/Restaurante/assets/img/Mesero/mesero.jpg");
...
<ul class="nav nav-pills flex-column mb-auto">
    <li>
        <a href="/Restaurante/views/mesero/mesero.php" class="nav-link text-white">
    ...
    <li>
        ...
        <ul class="dropdown-menu text-small shadow" aria-labelledby="dropdownUser1">
            <a class="dropdown-item " href="/Restaurante/views/mesero/realizarPedido.php">Realizar Pedido</a>
        </ul>
</ul>
<hr>
<div class="dropdown">
