...
<body>
                ...
                <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                    ...
                    <form id="formLogin" action="#" method="post">
                        ...
                        <div class="form-outline mb-4">
                            <label class="form-label fw-bold text-primario font-monospace" for="correo">Correo Electrónico</label>
                        ...
                        <div class="form-outline mb-3">
                            ...
                            <input type="checkbox" id="togglePassword"> <label class="form-label fw-bold text-primario font-monospace" for="clave">Mostrar contraseña</label>
                        </div>
    ...
    <script src="/Restaurante/scripts/mostrarContraseña.js"></script>
</body>
